...
const DialogContent = React.forwardRef(({ className, children, ...props }, ref) => (
  <DialogPortal>
    ...
    <DialogPrimitive.Content
      ref={ref}
      className={cn(
        'fixed left-1/2 top-1/2 z-50 grid w-[94vw] max-w-lg -translate-x-1/2 -translate-y-1/2 gap-4 rounded-lg border border-black/10 bg-background p-6 shadow-2xl duration-200 data-[state=open]:animate-in data-[state=closed]:animate-out sm:w-full',
        className,
      )}
      {...props}
    >
